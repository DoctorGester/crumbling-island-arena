return {
    ...
    "particles/am_damage/am_damage_%s.vpcf",
    ...
    "particles/units/heroes/hero_invoker/invoker_%s_orb.vpcf",
    "particles/econ/items/invoker/invoker_apex/invoker_apex_%s_orb.vpcf",
